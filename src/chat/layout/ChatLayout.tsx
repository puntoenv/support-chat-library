        ...
        <ScrollArea className="h-[calc(100vh-64px)]">
          <div className="space-y-4 p-4">
            ...
            <div className="pt-4 border-t mt-4">
              ...
              <NavLink to="/chat/6" className="w-full flex items-center">
